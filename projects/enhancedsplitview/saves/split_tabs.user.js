...
// @version      1.0
// @description  Official v1.0 release. Enhances Chrome's split tab view with link synchronization, role-based UI, and customizable keybindings.
// @author       You
// @match        *://*/*
...
(function () {
    ...
    console.log('Split Tab Manager: Script initialized (v1.0)');
    ...
    function initialize() {
        ...
        GM_registerMenuCommand("STM: Disconnect", broadcastDisconnect);
        GM_registerMenuCommand("STM: Configure Keys", showConfigPanel);
